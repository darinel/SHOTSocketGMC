...
Public Class WinSockServer
    Dim FILEPATH As String = "C:\tmp\GMC\"
...
#Region "FUNCIONES PRIVADAS"
    ...
    Private Function EscribeArchivo(ByVal strDatos As String, ByVal TNTag As String) As Boolean
        ...
        Dim strFile As String = FILEPATH + FILENAME + varTimeDate.ToString("MM_dd_yyyy_hh_mm_ss") + "_Live_GMC_" & TNTag & ".xml"
        'Vallarta
        'MPV
    ...
    Private Sub EscribeArchivoError(ByVal strDatos As String)
        ...
        Dim varTimeDate As DateTime
        varTimeDate = DateTime.Now
        Dim strFile As String = FILEPATH + FILENAME + varTimeDate.ToString("MM_dd_yyyy_hh_mm_ss") + "_Error_Live_GMC.xml"
        'MCT
        'MPV
