...
Public Class WinSockServer
    Dim FILEPATH As String = "C:\tmp\PR\"
...
#Region "FUNCIONES PRIVADAS"
    ...
    Private Function EscribeArchivo(ByVal strDatos As String, ByVal TNTag As String) As Boolean
        ...
        Dim strFile As String = FILEPATH + FILENAME + varTimeDate.ToString("MM_dd_yyyy_hh_mm_ss") + "_Live_PR_" & TNTag & ".xml"
        'Vallarta
        'MPV
    ...
    Public Sub SendEmailGoogle()
       ...
       .EnableSsl = True _
        ...
        client.Send("pmsalertbysol@gmail.com", "4072563998@mymetropcs.com", "Alert-PR", "PR Socket Problem")
    End Sub
